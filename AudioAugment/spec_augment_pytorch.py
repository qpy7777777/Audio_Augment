...
from AudioAugment.sparse_image_warp_pytorch import sparse_image_warp
import torch
...
def visualization_spectrogram(mel_spectrogram, title):
    ...
    librosa.display.specshow(librosa.power_to_db(mel_spectrogram[0, :, :]), y_axis='mel', x_axis='time')
    plt.title(title)
    plt.tight_layout()
    plt.show()
